    ...
    <div class="grid grid-cols-12 gap-8 justify-center w-full mt-10 xl:mt-40">
        ...
        <div class="col-span-12 xl:col-span-5 flex flex-col gap-4 text-center xl:text-left mt-8 px-8 xl:px-0 xl:mt-0">
            ...
            @foreach($projects as $project)
                <div class="flex flex-col items-center justify-between bg-[#111] border-4 border-[#222] rounded-lg shadow md:flex-row overflow-hidden">
                    ...
                    @if($project->snapshot)
                        <img class="object-cover rounded-t-lg h-full md:w-48 md:rounded-none" src="{{ asset('/storage/' . $project->snapshot) }}" alt="">
                    @endif
                </div>
            @endforeach
